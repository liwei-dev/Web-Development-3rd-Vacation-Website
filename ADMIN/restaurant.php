...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "insert into restaurant values ('$koderestaurant', '$namarestaurant', '$namafile', '$kodedestinasi')");
		}
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="koderestaurant" name="inputkode" placeholder="Kode restaurant" maxlength="4">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namarestaurant" name="inputnama" placeholder="Nama restaurant">
			</div>
		</div>
...
//	from destinasi");
	...
	{
		$search = $_POST["search"];
		$query = mysqli_query($connection, "select restaurant.* 
			from restaurant where restaurantNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
