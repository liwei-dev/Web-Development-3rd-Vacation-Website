...
<?php 
	...
	{
		$kodephoto = $_POST['inputkode'];
		$namaphoto = $_POST['inputnama'];
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "insert into fotodestinasi values ('$kodephoto', '$namaphoto', '$namafile', '$kodephoto')");
		}
...
<div class="col-sm-10">
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Input photo</h1>
		</div>
	</div>

	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			<label for="kodephoto" class="col-sm-2 col-form-label">Kode photo</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodephoto" name="inputkode" placeholder="Kode photo" maxlength="4">
			</div>
		</div>

		<div class="mb-3 row">
			<label for="namaphoto" class="col-sm-2 col-form-label">Nama photo</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namaphoto" name="inputnama" placeholder="Nama photo">
			</div>
		</div>
		...
		<div class="mb-3 row">
			<label for="file" class="col-sm-2 col-form-label">Photo photo</label>
			<div class="col-sm-10">
...
<div class="row">
	...
	<div class="col-sm-10">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-4">Daftar photo</h1>
			</div>
		</div>
		...
		<form method="POST">
                ...
                <label for="search" class="col-sm-3">Nama photo</label>
...
//	from destinasi");
	...
	{
		$search = $_POST["search"];
		$query = mysqli_query($connection, "select fotodestinasi.* 
			from fotodestinasi where fotodestinasiNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
