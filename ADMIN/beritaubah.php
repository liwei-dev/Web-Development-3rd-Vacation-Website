...
<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "update berita set beritaNAMA = '$namaberita', beritaFILE = '$namafile', destinasiKODE = '$kodedestinasi' where beritaKODE = '$kodeberita'");

		}
        mysqli_query($connection, "update berita set beritaNAMA = '$namaberita', destinasiKODE = '$kodedestinasi' where beritaKODE = '$kodeberita'");
    ...
    $editfoto= mysqli_query($connection,"select * from berita where beritaKODE = '$inputkode'");
    $rowedit = mysqli_fetch_array($editfoto);
    $editkode = mysqli_query($connection,"select * from berita, destinasi where beritaKODE = '$inputkode' and berita.destinasiKODE = destinasi.destinasiKODE");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodeberita" name="inputkode" placeholder="kodeberita" maxlength="4" value="<?php echo $rowedit["beritaKODE"]?>" readonly>
			</div>
		</div>

		<div class="mb-3 row">
			<label for="namaberita" class="col-sm-2 col-form-label">Nama hotel</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namaberita" name="inputnama" placeholder="namaberita" value="<?php echo $rowedit["beritaNAMA"]?>">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="file" id="file" name="file" value="<?php echo $rowedit["beritaFILE"]?>">
