...
<div class="col-sm-10">
 ...
 <form method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="kodedestinasi" id="kodedestinasi" maxlength="4" placeholder="Kode Destinasi">
    </div>
  </div>
...
<!--     <td><?php// echo $row['destinasiKODE'];?></td>  -->
     ...
     <td width="5px">
                    <!-- untuk icon edit dari icon bootstrap -->
                    <!--<a href="destinasiKeziaEdit.php?ubah=<?php echo $row["destinasiKODE"] ?>"
                        ...
                        <td>
                            <a href="destinasiHAPUSfoto.php?hapus=<?php echo $row["destinasiKODE"] ?>"
                                class="btn btn-danger btn-sm" title="HAPUS">
                                <i class="bi bi-trash"></i>  untuk icon trash -->
                        </td>
                </td>
