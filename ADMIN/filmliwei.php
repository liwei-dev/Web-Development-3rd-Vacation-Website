...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "insert into filmliwei values ('$kodefilmliwei', '$namafilmliwei', '$namafile', '$kodedestinasi')");
		}
...
<div class="col-sm-10">
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">POSTER FILM</h1>
		</div>
	</div>

	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			<label for="kodefilmliwei" class="col-sm-2 col-form-label">Kode filmliwei</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodefilmliwei" name="inputkode" placeholder="kodefilmliwei" maxlength="4">
			</div>
		</div>

		<div class="mb-3 row">
			<label for="namafilmliwei" class="col-sm-2 col-form-label">Nama Photo</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namafilmliwei" name="inputnama" placeholder="namafilmliwei">
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-sm-10">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-4">Daftar Poster Film</h1>
			</div>
		</div>
...
//	from destinasi");
	...
	{
		$search = $_POST["search"];
		$query = mysqli_query($connection, "select filmliwei.* 
			from filmliwei where filmliweiNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	

	}else
		{
			$query = mysqli_query($connection, "select filmliwei.*  from filmliwei limit $mulaitampilan, $jumlahtampilan");
		}
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
