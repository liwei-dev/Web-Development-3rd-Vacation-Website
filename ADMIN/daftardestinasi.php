...
//	from destinasi");
	if(isset($_POST["kirim"]))
	{
		...
		$query = mysqli_query($connection, "select * 
			from destinasi, kategoriwisata where destinasiNAMA like '%".$search."%' AND destinasi.kategoriKODE = kategoriwisata.kategoriKODE limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
