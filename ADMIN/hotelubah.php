...
<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "update hotel set hotelNAMA = '$namahotel', hotelFILE = '$namafile', destinasiKODE = '$kodedestinasi' where hotelKODE = '$kodehotel'");

		}
        mysqli_query($connection, "update hotel set hotelNAMA = '$namahotel', destinasiKODE = '$kodedestinasi' where hotelKODE = '$kodehotel'");
    ...
    $editfoto= mysqli_query($connection,"select * from hotel where hotelKODE = '$inputkode'");
    $rowedit = mysqli_fetch_array($editfoto);
    $editkode = mysqli_query($connection,"select * from hotel, destinasi where hotelKODE = '$inputkode' and hotel.destinasiKODE = destinasi.destinasiKODE");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodehotel" name="inputkode" placeholder="kodehotel" maxlength="4" value="<?php echo $rowedit["hotelKODE"]?>" readonly>
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namahotel" name="inputnama" placeholder="namahotel" value="<?php echo $rowedit["hotelNAMA"]?>">
			</div>
		</div>
...
<div class="row">
	...
	<table class="table table-hover table-danger">
		...
		<tbody>
				...
				<tr>
					...
					<td>
						<a href="hotelubah.php?ubahfoto=<?php echo $row['hotelKODE']?>" class="btn btn-success btn-sm" title="EDIT">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
					...
					<td>
						<a href="hotelhapus.php?hapusfoto=<?php echo $row['hotelKODE']?>" class="btn btn-danger btn-sm" title="DELETE">
