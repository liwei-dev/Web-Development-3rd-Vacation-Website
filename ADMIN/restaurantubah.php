...
<?php 
	...
	if(isset($_POST['edit']))
	{
		$koderestaurant = $_POST['inputkode'];
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "update restaurant set restaurantNAMA = '$namarestaurant', restaurantFILE = '$namafile', destinasiKODE = '$kodedestinasi' where restaurantKODE = '$koderestaurant'");

		}
        mysqli_query($connection, "update restaurant set restaurantNAMA = '$namarestaurant', destinasiKODE = '$kodedestinasi' where restaurantKODE = '$koderestaurant'");

	}

	$datadestinasi = mysqli_query($connection, "select * from destinasi");
    $inputkode = $_GET['ubahfoto'];
    $editfoto= mysqli_query($connection,"select * from restaurant where restaurantKODE = '$inputkode'");
    $rowedit = mysqli_fetch_array($editfoto);
    $editkode = mysqli_query($connection,"select * from restaurant, destinasi where restaurantKODE = '$inputkode' and restaurant.destinasiKODE = destinasi.destinasiKODE");
...
<div class="col-sm-10">
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Input restaurant</h1>
		</div>
	</div>
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="koderestaurant" name="inputkode" placeholder="Kode restaurant" maxlength="4" value="<?php echo $rowedit["restaurantKODE"]?>" readonly>
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namarestaurant" name="inputnama" placeholder="Nama restaurant" value="<?php echo $rowedit["restaurantNAMA"]?>">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="file" id="file" name="file" value="<?php echo $rowedit["restaurantFILE"]?>">
...
<div class="row">
	...
	<table class="table table-hover table-danger">
		...
		<tbody>
				...
				<tr>
					...
					<td>
						<?php if(is_file("images/".$row['restaurantFILE']))
						{ ?>
							<img src="images/<?php echo $row['restaurantFILE']?>" width="80">
						<?php } else
					...
					<td>
						<a href="restaurantubah.php?ubahfoto=<?php echo $row['restaurantKODE']?>" class="btn btn-success btn-sm" title="EDIT">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
					...
					<td>
						<a href="restauranthapus.php?hapusfoto=<?php echo $row['restaurantKODE']?>" class="btn btn-danger btn-sm" title="DELETE">
