...
<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "JPEG"))
		{
			...
			mysqli_query($connection, "update travel set travelNAMA = '$namatravel', travelFILE = '$namafile', destinasiKODE = '$kodedestinasi' where travelKODE = '$kodetravel'");

		}
        mysqli_query($connection, "update travel set travelNAMA = '$namatravel', destinasiKODE = '$kodedestinasi' where travelKODE = '$kodetravel'");
    ...
    $editfoto= mysqli_query($connection,"select * from travel where travelKODE = '$inputkode'");
    $rowedit = mysqli_fetch_array($editfoto);
    $editkode = mysqli_query($connection,"select * from travel, destinasi where travelKODE = '$inputkode' and travel.destinasiKODE = destinasi.destinasiKODE");
...
<div class="col-sm-10">
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Input travel</h1>
		</div>
	</div>
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodetravel" name="inputkode" placeholder="kodetravel" maxlength="4" value="<?php echo $rowedit["travelKODE"]?>" readonly>
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namatravel" name="inputnama" placeholder="namatravel" value="<?php echo $rowedit["travelNAMA"]?>">
			</div>
		</div>
		...
		<div class="mb-3 row">
			...
			<div class="col-sm-10">
				<input type="file" id="file" name="file" value="<?php echo $rowedit["travelFILE"]?>">
...
<div class="row">
	...
	<table class="table table-hover table-danger">
		...
		<tbody>
				...
				<tr>
					...
					<td>
						<a href="travelubah.php?ubahfoto=<?php echo $row['travelKODE']?>" class="btn btn-success btn-sm" title="EDIT">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
					...
					<td>
						<a href="travelhapus.php?hapusfoto=<?php echo $row['travelKODE']?>" class="btn btn-danger btn-sm" title="DELETE">
