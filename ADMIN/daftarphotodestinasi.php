...
<div class="row">
	...
	<div class="col-sm-10">
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h1 class="display-4">Daftar Foto Wisata</h1>
			</div>
		</div>
...
{
    $search = $_POST["search"];
	$query = mysqli_query($connection,"select * from fotodestinasi, destinasi where fotodestinasi.destinasiKODE = destinasi.destinasiKODE 
	AND fotodestinasiNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	

}else
    {
        $query = mysqli_query($connection, "select *  from fotodestinasi, destinasi where fotodestinasi.destinasiKODE = destinasi.destinasiKODE limit $mulaitampilan, $jumlahtampilan");
    }
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
