...
{
    $search = $_POST["search"];
	$query = mysqli_query($connection,"select * from berita, destinasi where berita.destinasiKODE = destinasi.destinasiKODE 
	AND beritaNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	

}else
    {
        $query = mysqli_query($connection, "select *  from berita, destinasi where berita.destinasiKODE = destinasi.destinasiKODE limit $mulaitampilan, $jumlahtampilan");
    }
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
